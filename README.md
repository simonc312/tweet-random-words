...
```java
// RestClient.java
public static final String REST_CALLBACK_URL = "oauth://your_oauth_callback";
```
...
Open `LoginActivity.java` and configure the `onLoginSuccess` method
